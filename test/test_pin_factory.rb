...
class TestPinFactory < Test::Unit::TestCase
    ...
    def create_factory
        ...
        Tool::PinFactory.new(
            ...
            :copper_diameter => Pcb::Coord.parse("3 mm"),
            :drill_diameter => Pcb::Coord.parse("4 mm")
            )
    end
    ...
    def test_deserialization
        ...
        factory2 = Tool::PinFactory.create_json object1
